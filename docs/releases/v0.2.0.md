...
See the [`CHANGELOG.md`](https://github.com/littlejoely/omeety-terminal/blob/main/CHANGELOG.md),
the [Browser Core v2 report](https://github.com/littlejoely/omeety-terminal/blob/main/docs/browser-core-v2.md),
the Chinese [README](https://github.com/littlejoely/omeety-terminal/blob/main/README.md),
and the English [README](https://github.com/littlejoely/omeety-terminal/blob/main/README.en.md)
for details.
